                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        Teachers / <a  class="btn"  data-toggle="modal" data-target="#staticBackdrop" >Add Teachers</a>
                                                    </div>
                                                    <div class="card-body">
                                                    <table id="example" class="display" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                <?php $a = 1; $b = 1; $c = 1; for ($i=0; $i < 25 ; $i++) {  ?>
                                                                    ...
                                                                    <td><a href=""><i class="fi fi-rr-eye text-secondary" style="font-size: 20px;"></i></a> <a href=""><i class="fi fi-rr-edit text-secondary" style="font-size: 20px;"></i></a> <i class="fi fi-rr-trash-xmark text-danger" onclick="deletes()" style="font-size: 20px;"></i> </td>
                                                                </tr> 
                                                                <?php }?>
