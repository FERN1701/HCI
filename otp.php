...
<head>
    <title><?php echo $title?></title>
      ...
      <link rel="icon" href="./images/CCSlogo.png" type="image/x-icon">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">OTP Passcode</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <a href="newpass.php" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Verify Code</a>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <img src="./images/logo.png" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
