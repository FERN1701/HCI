...
<?php include "head.php"; $main = 6; $sub= 0;?>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0"><?php echo $title?> Announcement Pannel</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        Announcement / <a  class="btn"  data-toggle="modal" data-target="#staticBackdrop" >Add Announcement</a>
                                                    </div>
                                                    <div class="card-body">
                                                    <table id="example" class="display" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                <?php $a = 1; $b = 1; $c = 1; for ($i=0; $i < 25 ; $i++) {  ?>
                                                                    <tr>
                                                                    <td>Announcement <?php echo $a++?></td>
                                                                    <td>Date <?php echo rand(00,12)?> / <?php echo rand(11,30)?>/ <?php echo rand(2022,2023)?></td>
                                                                    <td><a href="" data-toggle="modal" data-target="#view"><i class="fi fi-rr-eye text-secondary" style="font-size: 20px;"></i></a> <a href="" data-toggle="modal" data-target="#edit" ><i class="fi fi-rr-edit text-secondary" style="font-size: 20px;"></i></a> <i onclick="deletes()" class="fi fi-rr-trash-xmark text-danger" style="font-size: 20px;"></i> </td>
                                                                </tr> 
                                                                <?php }?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editLabel">Announcement Blogs</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="viewLabel">View Announcement</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
